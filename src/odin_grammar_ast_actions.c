...
#define DEFINE_ACTION(name, node_type, capture_text)                                                                   \
    ...
    {                                                                                                                  \
        (void)user_data;                                                                                               \
        make_node(ctx, node, children, count, node_type, capture_text);                                                \
    }
...
DEFINE_ACTION(ast_action_external_declarations_action, AST_NODE_EXTERNAL_DECLARATIONS, false)
DEFINE_ACTION(ast_action_package_clause_action, AST_NODE_PACKAGE_CLAUSE, false)
...
DEFINE_ACTION(ast_action_slice_type_action, AST_NODE_SLICE_TYPE, false)
DEFINE_ACTION(ast_action_map_type_action, AST_NODE_MAP_TYPE, false)
DEFINE_ACTION(ast_action_soa_type_action, AST_NODE_SOA_TYPE, false)
DEFINE_ACTION(ast_action_enum_type_action, AST_NODE_ENUM_TYPE, false)
DEFINE_ACTION(ast_action_enum_type_ref_action, AST_NODE_ENUM_TYPE_REF, false)
DEFINE_ACTION(ast_action_union_type_action, AST_NODE_UNION_TYPE, false)
DEFINE_ACTION(ast_action_bit_field_type_action, AST_NODE_BIT_FIELD_TYPE, false)
DEFINE_ACTION(ast_action_bit_set_type_action, AST_NODE_BIT_SET_TYPE, false)
DEFINE_TERMINAL_ACTION(ast_action_bit_set_range_action, AST_NODE_BIT_SET_RANGE)
DEFINE_ACTION(ast_action_struct_type_action, AST_NODE_STRUCT_TYPE, false)
DEFINE_ACTION(ast_action_struct_type_ref_action, AST_NODE_STRUCT_TYPE_REF, false)
DEFINE_ACTION(ast_action_distinct_type_action, AST_NODE_DISTINCT_TYPE, false)
DEFINE_ACTION(ast_action_procedure_signature_action, AST_NODE_PROCEDURE_SIGNATURE, false)
DEFINE_ACTION(ast_action_parameter_action, AST_NODE_PARAMETER, false)
DEFINE_ACTION(ast_action_parameters_action, AST_NODE_PARAMETERS, false)
DEFINE_ACTION(ast_action_parameter_list_action, AST_NODE_PARAMETER_LIST, false)
DEFINE_ACTION(ast_action_named_return_action, AST_NODE_NAMED_RETURN, false)
DEFINE_ACTION(ast_action_return_list_action, AST_NODE_RETURN_LIST, false)
DEFINE_ACTION(ast_action_return_type_list_action, AST_NODE_RETURN_TYPE_LIST, false)
DEFINE_ACTION(ast_action_returns_action, AST_NODE_RETURNS, false)
DEFINE_ACTION(ast_action_where_clause_action, AST_NODE_WHERE_CLAUSE, false)
DEFINE_ACTION(ast_action_calling_convention_action, AST_NODE_CALLING_CONVENTION, false)
DEFINE_ACTION(ast_action_context_expr_action, AST_NODE_CONTEXT_EXPR, false)
DEFINE_ACTION(ast_action_primary_expression_action, AST_NODE_PRIMARY_EXPRESSION, false)
DEFINE_ACTION(ast_action_postfix_call_action, AST_NODE_POSTFIX_CALL, false)
DEFINE_ACTION(ast_action_postfix_subscript_action, AST_NODE_POSTFIX_SUBSCRIPT, false)
...
DEFINE_ACTION(ast_action_postfix_member_action, AST_NODE_POSTFIX_MEMBER, false)
DEFINE_ACTION(ast_action_postfix_deref_action, AST_NODE_POSTFIX_DEREF, false)
DEFINE_ACTION(ast_action_postfix_assertion_action, AST_NODE_POSTFIX_ASSERTION, false)
DEFINE_ACTION(ast_action_postfix_ops_action, AST_NODE_POSTFIX_OPS, false)
DEFINE_ACTION(ast_action_postfix_expression_action, AST_NODE_POSTFIX_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_unary_op_action, AST_NODE_UNARY_OP)
DEFINE_ACTION(ast_action_unary_prefix_action, AST_NODE_UNARY_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_mul_op_action, AST_NODE_MUL_OP)
DEFINE_ACTION(ast_action_mul_expression_action, AST_NODE_MUL_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_add_op_action, AST_NODE_ADD_OP)
DEFINE_ACTION(ast_action_add_expression_action, AST_NODE_ADD_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_shift_op_action, AST_NODE_SHIFT_OP)
DEFINE_ACTION(ast_action_shift_expression_action, AST_NODE_SHIFT_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_bit_and_op_action, AST_NODE_BIT_AND_OP)
DEFINE_ACTION(ast_action_bit_and_expression_action, AST_NODE_BIT_AND_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_bit_xor_op_action, AST_NODE_BIT_XOR_OP)
DEFINE_ACTION(ast_action_bit_xor_expression_action, AST_NODE_BIT_XOR_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_bit_or_op_action, AST_NODE_BIT_OR_OP)
DEFINE_ACTION(ast_action_bit_or_expression_action, AST_NODE_BIT_OR_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_comp_op_action, AST_NODE_COMP_OP)
DEFINE_ACTION(ast_action_comp_expression_action, AST_NODE_COMP_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_log_and_op_action, AST_NODE_LOG_AND_OP)
DEFINE_ACTION(ast_action_log_and_expression_action, AST_NODE_LOG_AND_EXPRESSION, false)
DEFINE_OP_ACTION(ast_action_log_or_op_action, AST_NODE_LOG_OR_OP)
DEFINE_ACTION(ast_action_log_or_expression_action, AST_NODE_LOG_OR_EXPRESSION, false)
...
// TernaryExpression = RangeExpression ((KwIf TernaryExpression KwElse TernaryExpression)
//                                    | (Question Expression Colon Expression))?
//   no tail:              [then/cond]          -> 1 child (delegated downstream)
//   'if' tail:            [then, cond, else]   -> reorder to [cond, then, else]
//   '?'  tail:            [cond, then, else]   -> already in convention order
// The tail form is detected by the second child's type: the 'if' cond is a
// TernaryExpression, the '?' then-branch is an Expression.
static void
ast_action_ternary_expression_action(
    epc_ast_builder_ctx_t * ctx, epc_cpt_node_t * node, void ** children, int count, void * user_data
)
{
    (void)user_data;
    if (count == 3 && children[1] != NULL
        && ((odin_grammar_node_t *)children[1])->type == AST_NODE_TERNARY_EXPRESSION)
    {
        void * reordered[3] = {children[1], children[0], children[2]};
        make_node(ctx, node, reordered, count, AST_NODE_TERNARY_EXPRESSION, false);
        return;
    }
    make_node(ctx, node, children, count, AST_NODE_TERNARY_EXPRESSION, false);
}
...
DEFINE_ACTION(ast_action_assign_expression_action, AST_NODE_ASSIGN_EXPRESSION, false)
DEFINE_ACTION(ast_action_expression_action, AST_NODE_EXPRESSION, false)
DEFINE_ACTION(ast_action_argument_list_action, AST_NODE_ARGUMENT_LIST, false)
DEFINE_ACTION(ast_action_compound_statement_action, AST_NODE_COMPOUND_STATEMENT, false)
DEFINE_ACTION(ast_action_defer_statement_action, AST_NODE_DEFER_STATEMENT, false)
DEFINE_ACTION(ast_action_when_statement_action, AST_NODE_WHEN_STATEMENT, false)
DEFINE_ACTION(ast_action_if_statement_action, AST_NODE_IF_STATEMENT, false)
DEFINE_ACTION(ast_action_for_statement_action, AST_NODE_FOR_STATEMENT, false)
DEFINE_ACTION(ast_action_switch_statement_action, AST_NODE_SWITCH_STATEMENT, false)
DEFINE_ACTION(ast_action_switch_case_action, AST_NODE_SWITCH_CASE, false)
DEFINE_ACTION(ast_action_switch_default_action, AST_NODE_SWITCH_DEFAULT, false)
DEFINE_ACTION(ast_action_return_statement_action, AST_NODE_RETURN_STATEMENT, false)
DEFINE_ACTION(ast_action_break_statement_action, AST_NODE_BREAK_STATEMENT, false)
DEFINE_ACTION(ast_action_continue_statement_action, AST_NODE_CONTINUE_STATEMENT, false)
DEFINE_ACTION(ast_action_fallthrough_statement_action, AST_NODE_FALLTHROUGH_STATEMENT, false)
DEFINE_ACTION(ast_action_assign_statement_action, AST_NODE_ASSIGN_STATEMENT, false)
...
DEFINE_ACTION(ast_action_constant_decl_action, AST_NODE_CONSTANT_DECL, false)
DEFINE_ACTION(ast_action_attribute_action, AST_NODE_ATTRIBUTE, false)
DEFINE_ACTION(ast_action_attr_list_action, AST_NODE_ATTR_LIST, false)
DEFINE_ACTION(ast_action_attr_item_action, AST_NODE_ATTR_ITEM, false)
DEFINE_ACTION(ast_action_foreign_import_action, AST_NODE_FOREIGN_IMPORT, false)
DEFINE_ACTION(ast_action_foreign_block_action, AST_NODE_FOREIGN_BLOCK, false)
DEFINE_ACTION(ast_action_when_decl_action, AST_NODE_WHEN_DECL, false)
DEFINE_ACTION(ast_action_when_body_action, AST_NODE_WHEN_BODY, false)
DEFINE_ACTION(ast_action_using_decl_action, AST_NODE_USING_DECL, false)
DEFINE_ACTION(ast_action_enumerator_action, AST_NODE_ENUMERATOR, false)
DEFINE_ACTION(ast_action_enumerator_list_action, AST_NODE_ENUMERATOR_LIST, false)
DEFINE_ACTION(ast_action_union_field_action, AST_NODE_UNION_FIELD, false)
...
DEFINE_ACTION(ast_action_len_expr_action, AST_NODE_LEN_EXPR, false)
DEFINE_ACTION(ast_action_cap_expr_action, AST_NODE_CAP_EXPR, false)
DEFINE_ACTION(ast_action_size_of_expr_action, AST_NODE_SIZE_OF_EXPR, false)
DEFINE_ACTION(ast_action_align_of_expr_action, AST_NODE_ALIGN_OF_EXPR, false)
DEFINE_ACTION(ast_action_offset_of_expr_action, AST_NODE_OFFSET_OF_EXPR, false)
DEFINE_ACTION(ast_action_raw_data_expr_action, AST_NODE_RAW_DATA_EXPR, false)
DEFINE_ACTION(ast_action_min_expr_action, AST_NODE_MIN_EXPR, false)
DEFINE_ACTION(ast_action_max_expr_action, AST_NODE_MAX_EXPR, false)
DEFINE_ACTION(ast_action_type_of_expr_action, AST_NODE_TYPE_OF_EXPR, false)
DEFINE_ACTION(ast_action_typeid_of_expr_action, AST_NODE_TYPEID_OF_EXPR, false)
DEFINE_ACTION(ast_action_type_info_of_expr_action, AST_NODE_TYPE_INFO_OF_EXPR, false)
DEFINE_ACTION(ast_action_make_expr_action, AST_NODE_MAKE_EXPR, false)
DEFINE_ACTION(ast_action_new_expr_action, AST_NODE_NEW_EXPR, false)
DEFINE_ACTION(ast_action_delete_expr_action, AST_NODE_DELETE_EXPR, false)
DEFINE_ACTION(ast_action_append_expr_action, AST_NODE_APPEND_EXPR, false)
DEFINE_ACTION(ast_action_incl_expr_action, AST_NODE_INCL_EXPR, false)
DEFINE_ACTION(ast_action_excl_expr_action, AST_NODE_EXCL_EXPR, false)
DEFINE_ACTION(ast_action_complex_expr_action, AST_NODE_COMPLEX_EXPR, false)
DEFINE_ACTION(ast_action_quaternion_expr_action, AST_NODE_QUATERNION_EXPR, false)
DEFINE_ACTION(ast_action_multi_pointer_type_action, AST_NODE_MULTI_POINTER_TYPE, false)
DEFINE_ACTION(ast_action_maybe_type_action, AST_NODE_MAYBE_TYPE, false)
DEFINE_ACTION(ast_action_proc_overload_bundle_action, AST_NODE_PROC_OVERLOAD_BUNDLE, false)
DEFINE_ACTION(ast_action_expand_values_expr_action, AST_NODE_EXPAND_VALUES_EXPR, false)
DEFINE_ACTION(ast_action_compress_values_expr_action, AST_NODE_COMPRESS_VALUES_EXPR, false)
...
#define REGISTER(id, cb) epc_ast_hook_registry_set_action(registry, id, cb)
    ...
    REGISTER(AST_ACTION_ARRAY_LIT_EXPR, ast_action_array_lit_expr_action);
    REGISTER(AST_ACTION_ARRAY_LIT_ELEMENTS, ast_action_array_lit_elements_action);
    REGISTER(AST_ACTION_QUATERNION_NAMED_ARG, ast_action_quaternion_named_arg_action);
    REGISTER(AST_ACTION_QUATERNION_NAMED_ARGS, ast_action_quaternion_named_args_action);
    ...
    REGISTER(AST_ACTION_APPEND_EXPR, ast_action_append_expr_action);
