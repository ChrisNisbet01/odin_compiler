...
DEFINE_ACTION(ast_action_tuple_type_action, AST_NODE_TUPLE_TYPE)
...
DEFINE_ACTION(ast_action_soa_zip_expr_action, AST_NODE_SOA_ZIP_EXPR)
DEFINE_ACTION(ast_action_soa_unzip_expr_action, AST_NODE_SOA_UNZIP_EXPR)
